	...
	**/
	...
	public String toString() {
		if (getRecurring() == null) {
            return getName()+" "+(getDate().getMonth().getValue() + "/" + getDate().getDayOfMonth() + "/" + getDate().getYear() % 2000 + " "
            ...
            return getName()+" "+(getRecurring().getWeek() + " "
                    ...
                    + getDate().getMonth().getValue() + "/" + getDate().getDayOfMonth() + "/" + getDate().getYear() % 2000 + " "
